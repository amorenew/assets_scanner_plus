...
import 'package:assets_scanner_plus/src/assets_builder.dart';
...
void main() {
  ...
  group('generate with assets_scanner_plus_options.yaml', () {
    test('generate nothing path not sub-path of lib/', () async {
      final optionsFile = io.File('assets_scanner_plus_options.yaml')
        ..createSync()
